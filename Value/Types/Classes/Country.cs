...
public class Country : IArcObject
{
    ...
    public static Walker Call(Walker i)
    {
        ...
        Country countr = new(
            key,
            args.Get(ArcCode.Constructor, "historical_idea_groups", new()),
            args.Get(ArcCode.Constructor, "historical_units", new()),
            args.Get(ArcCode.Constructor, "monarch_names", new()),
            args.Get(ArcCode.Constructor, "leader_names", new()),
            args.Get(ArcCode.Constructor, "ship_names", new()),
            args.Get(ArcCode.Constructor, "army_names", new("\"Army of $PROVINCE$\"")),
            args.Get(ArcCode.Constructor, "fleet_names", new("\"Fleet of $PROVINCE$\"")),
            ...
            args.Get(ArcString.Constructor, "government", new("monarchy")),
            args.Get(ArcInt.Constructor, "government_rank", new(1)),
            args.Get(ArcInt.Constructor, "mercantilism", new(1)),
            ...
            args.Get(ArcCode.Constructor, "definitions", new()),
            args.Get(ArcEffect.Constructor, "history", new()),
