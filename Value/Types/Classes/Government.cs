...
public class ReformLevel : ArcObject
{
    ...
    public static ReformLevel Constructor(string id, Args args) =>
        new()
        {
            { "id", new ArcString(id) },
    ...
    public override Walker Call(Walker i, ref Block result)
    {
        ...
        if (i.Current == "new")
        {
            ...
            Get<ArcList<GovernmentReform>>("reforms")
                .Values.Add(GovernmentReform.Constructor(id, args));
        }
        else
        {
            Get<ArcList<GovernmentReform>>("reforms")
                .Values.Add(GovernmentReform.GovernmentReforms[i.Current]);
        }
        return i;
    }
}
...
public class Government : ArcObject
{
    ...
    public static Government Constructor(string id, Args args) =>
        new(id)
        {
            { "id", new ArcString(id) },
            ...
            { "color", args.Get(ArcCode.Constructor, "color") },
            {
                "reform_levels",
                args.Get(
                    ArcList<ReformLevel>.GetConstructor(ReformLevel.Constructor),
                    "reform_levels"
                )
            },
        };
    ...
    public void Transpile(ref Block a, ref Block b)
    {
        ...
        a.Add(id, "=", "{", "basic_reform", "=", $"{id}_mechanic");
    ...
    public static string Transpile()
    {
        ...
        Program.OverwriteFile(
            $"{Program.TranspileTarget}/common/governments/arc.txt",
            string.Join(' ', a)
        );
        Program.OverwriteFile(
            $"{Program.TranspileTarget}/common/government_reforms/basic_reforms.txt",
            string.Join(' ', b)
        );
        return "Governments";
    }
...
public class GovernmentNames : ArcObject
{
    ...
    public static GovernmentNames Constructor(string id, Args args) =>
        new(id)
        {
            { "id", new ArcString(id) },
            ...
            {
                "ruler_male",
                args.Get(Dict<ArcString>.Constructor(ArcString.Constructor), "ruler_male")
            },
            {
                "ruler_female",
                args.Get(Dict<ArcString>.Constructor(ArcString.Constructor), "ruler_female")
            },
            {
                "consort_male",
                args.Get(Dict<ArcString>.Constructor(ArcString.Constructor), "consort_male")
            },
            {
                "consort_female",
                args.Get(Dict<ArcString>.Constructor(ArcString.Constructor), "consort_female")
            },
            {
                "heir_male",
                args.Get(Dict<ArcString>.Constructor(ArcString.Constructor), "heir_male")
            },
            {
                "heir_female",
                args.Get(Dict<ArcString>.Constructor(ArcString.Constructor), "heir_female")
            },
    ...
    public static string Transpile()
    {
        ...
        Program.OverwriteFile(
            $"{Program.TranspileTarget}/common/government_names/arc.txt",
            string.Join(' ', a)
        );
